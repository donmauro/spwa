...
spa.shell = (function () {
  ...
  var
    ...
    // Returns copy of stored anchor map; minimizer overhead
    copyAnchorMap = function () {
      return $.extend( true, {}, stateMap.anchor_map );
    };
    //------ END BEGIN UTILITY METHODS
    ...
    // Begin Event handler /onHaschange/
    ...
    // Begin revert anchor if slider denied
    if ( ! is_ok ) {
      if ( anchor_map_previous ) {
        $.uriAnchor.setAnchor( anchor_map_previous, null, true );
    ...
    // Arguments:
    // * position_type - may be 'close' or 'opened'
    // Action:
    ...
    // Purpose :
    // Directs she Shell to offer its capability to the user
    // Arguments:
