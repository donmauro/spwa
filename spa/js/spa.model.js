 ...
 * people-model - the people model object wich provides methods
...
spa.model = (function () {
  ...
  //   * get_user() - return the currentuser person object.
  ...
  //     completes. The update user object is provided as data.
  ...
  //     is only different from the id attributes
  //     if the client data is not synced with the backend.
  //   * id - the unique id. This may be defined if the
  ...
  // The chat object API
  // ---------------------
  // The chat object is abailable at spa.model.chat
  // The chat object provides methods and events to manage
  // chat messaging. Its public methods and event to manage
  //  * join() - joins th chat room. This routine set sup
  ...
  //    join() aborts and return false.
  //  * get_chatee() - return the person object with whom the user
  //    is chatting. If there no chatee, null is returned.
  ...
  //    person requested is already the chatee, it return false.
  //    It publishes a 'spa_setchatee' global custom event.
  ...
  //    'spa-listchange' event wich publishes the updated
  ...
  //    online people change in length (i.e. when a person
  ...
  //  * spa-updatechat - This is published whe a nre message
  ...
  chat = (function () {
    ...
    _update_list = function( arg_list) {
      ...
      clearPeopleDb();
      console.warn('updatelist:' + people_list.length);
      PERSON:
      for ( i = 0; i < people_list.length; i++ ) {
        ...
        // if user defined, update css_map ans skip remainder
      ...
      // wich triggers the 'spa-setchatee' global event
    ...
    send_msg = function ( msg_text ) {
      ...
      // we published updatechat so we can our outgoing messages
  ...
  initModule = function () {
    ...
    //initialize anonymous person_map
